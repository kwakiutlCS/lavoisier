$(function() {
	...
	for (var k in this.composition) {
		...
		ctx.fillText(this.composition[k], dx+(w-this.radius*Object.size(this.composition)*w/1366.)*this.x+counter*this.radius*w/1366.+this.radius*w/1366./2.7 , dy+(h-this.radius*h/768.)*this.y+this.radius*h/768./1.4);
	    counter += 1;
	}
    };
